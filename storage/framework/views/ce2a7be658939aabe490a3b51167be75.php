            ...
            <div>
                ...
                <div class="space-y-1.5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $people->where('type', 'professor')->sortBy('name'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <button type="button" @click="removePerson('<?php echo e($person->id); ?>', '<?php echo e(addslashes($person->name)); ?>')"
                                x-show="'<?php echo e(addslashes($person->name)); ?>'.toLowerCase().includes(removeFilter.toLowerCase())"
...
<?php /**PATH C:\Users\Mateus Amaro\Documents\DevMenthors\Cronograma de Aulas\resources\views/schedule/modals/remove-person.blade.php ENDPATH**/ ?>