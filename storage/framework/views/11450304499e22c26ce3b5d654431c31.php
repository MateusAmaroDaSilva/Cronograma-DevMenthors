        ...
        <div class="grid" style="grid-template-columns: 140px repeat(4, 1fr); gap: 1rem;">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($day = 0; $day < 4; $day++): ?>
                <div class="text-center pb-2">
                    ...
                    <div class="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-0.5">
                        ...
                        <?php echo e(\Carbon\Carbon::createFromDate($currentYear, $currentMonth, 1)->translatedFormat('M')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex items-center min-h-[120px]">
                    <span class="font-semibold text-sm <?php echo e($class->level === 'advanced' ? 'text-teacher-tag-text' : 'text-mentor-tag-text'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php for($day = 0; $day < 4; $day++): ?>
                    ...
                    <div x-data="{ isOver: false, error: '' }"
                         ...
                         @drop.prevent="
                             ...
                             if (personId) {
                                 assignSubstitute(personId, <?php echo e($day); ?>, '<?php echo e($class->id); ?>');
                             }
                         "
                         :class="{
                         ...
                         id="sub-<?php echo e($class->id); ?>-<?php echo e($day); ?>">

                        
                        <div class="flex-1 flex flex-col gap-1.5">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($cellSubs->isNotEmpty()): ?>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $cellSubs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $substitute): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="group flex items-center justify-between gap-1 px-2.5 py-1.5 rounded-lg text-xs font-medium transition-all
                                        <?php echo e($substitute->person->type === 'professor'
                                        ...
                                        <span class="truncate flex items-center gap-1">
                                            ...
                                            <?php echo e($substitute->person->name); ?>

                                        </span>
                                        <button @click="removeSubstitute(<?php echo e($substitute->id); ?>)"
...
<?php /**PATH C:\Users\Mateus Amaro\Documents\DevMenthors\Cronograma de Aulas\resources\views/schedule/substitutes.blade.php ENDPATH**/ ?>