...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> — Cronograma de Aulas</title>
...
<body class="bg-gray-100 text-gray-900/80 font-inter antialiased" style="font-feature-settings: 'tnum';">
    ...
    <div x-data="scheduleBoard(<?php echo e(json_encode([
        ...
        <header class="flex items-center justify-between px-8 py-4 bg-white/80 backdrop-blur-sm border-b border-gray-200/50">
            <div class="flex items-center gap-3">
                <img src="<?php echo e(asset('assets/devmenthors_LogoColor.png')); ?>" alt="DevMenthors" class="h-8 w-auto">
        ...
        <div class="flex flex-1 overflow-hidden">
            <?php echo $__env->make('schedule.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                ...
                <?php echo $__env->make('schedule.grid', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

                <?php echo $__env->make('schedule.substitutes', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>

        <?php echo $__env->make('schedule.modals.add-person', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('schedule.modals.remove-person', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('schedule.modals.password-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <?php echo $__env->make('schedule.modals.toast', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

</body>
</html>
<?php /**PATH C:\Users\Mateus Amaro\Documents\DevMenthors\Cronograma de Aulas\resources\views/schedule/index.blade.php ENDPATH**/ ?>